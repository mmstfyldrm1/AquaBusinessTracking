...
namespace AquaBusinessTrackingWebUI.ViewComponents
{
    public class _AdminLayoutStockComponentPartial : ViewComponent
    {
        ...
        public _AdminLayoutStockComponentPartial(AuthorizedHttpClientService httpClientFactory, IOptions<ApiSettings> apiSettings)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            try
            {
                ...
                var previousDayTask = client.GetAsync($"{_apiSettings.BaseUrl}/SentezIntegrations/getpreviousdaystock", cts.Token);
                var stockTask = client.GetAsync($"{_apiSettings.BaseUrl}/SentezIntegrations/getstock", cts.Token);
