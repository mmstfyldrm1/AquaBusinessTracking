...
namespace AquaBusinessTrackingWebApi.Controllers
{
    ...
    public class PlanningScorBoardViewController : ControllerBase
    {
        ...
        public PlanningScorBoardViewController(IPlanningScorBoardViewService service)
        {
            _service = service;
        }
        [HttpGet("getall")]
        ...
        [HttpPut("update/{id}")]
        public async Task<IActionResult> Update([FromBody] UpdatePlanningScorBoardViewDto dto)
        {
