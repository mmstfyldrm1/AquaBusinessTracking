...
namespace AquaBusinessTrackingWebApi.Controllers
{
    ...
    public class PapperMachineChemicalController : ControllerBase
    {
        ...
        public PapperMachineChemicalController(IPapperMachineChemicalService service)
        {
            _service = service;
        }
        [HttpGet("getall")]
        ...
        [HttpPut("update/{id}")]
        public async Task<IActionResult> Update([FromBody] UpdatePapperMachineChemicalDto dto)
        {
