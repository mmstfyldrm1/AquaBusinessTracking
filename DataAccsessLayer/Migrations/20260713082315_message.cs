    ...
    public partial class message : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Db_Message", x => x.RecId);
                    table.ForeignKey(
                        name: "FK_Db_Message_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Db_Message_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Db_Message_ReceiverId",
                table: "Db_Message",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_Db_Message_SenderId",
                table: "Db_Message",
                column: "SenderId");
